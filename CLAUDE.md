...
Use the existing engine factories and adapter matrix. Follow root rules for public contracts, licensing, migration, verification and git authorization. Do not rely on obsolete Maven / Yarn commands, dual designer modes, built-in form management or SQL Server support.
