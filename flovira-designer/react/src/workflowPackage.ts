import { NODE_KEY_PATTERN, normalizeDefinition } from './model'
import type { FloviraDefinition } from './types'

export type PackageDefinition = FloviraDefinition
const normalizePackageDefinition = (value: FloviraDefinition): PackageDefinition => normalizeDefinition(value)
