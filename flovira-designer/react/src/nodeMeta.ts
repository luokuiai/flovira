import { Check, CircleDot, GitBranch, GitFork, Hourglass, Mail, Network, UserRoundCheck, Workflow } from 'lucide-react'
...
export const NODE_META: Record<FloviraNodeType, {
  ...
  '5': { label: '多选分支', icon: Network, tone: 'inclusive', color: '#8b5cf6' },
  '6': { label: '子流程', icon: Workflow, tone: 'subprocess', color: '#b85c38' },
