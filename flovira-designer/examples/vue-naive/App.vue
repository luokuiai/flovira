        ...
        <div class="demo-hero-inner">
          <div class="demo-hero-text">
            <div class="demo-hero-brand">
              ...
              <h1>Flovira Designer<span class="ui-badge ui-badge--naive">Naive UI</span></h1>
            </div>
...
import { naiveAdapter } from '@luokuiai/flovira-vue-designer/naive'   // ← Naive UI 适配器子入口
...
app.use(naive).use(FloviraDesigner)   // ③ 注册后模板里直接用 <FlowDesigner />`
