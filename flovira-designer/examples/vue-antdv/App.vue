        ...
        <div class="demo-hero-inner">
          <div class="demo-hero-text">
            <div class="demo-hero-brand">
              ...
              <h1>Flovira Designer<span class="ui-badge ui-badge--antd">Ant Design Vue 4</span></h1>
            </div>
...
import { antdvAdapter } from '@luokuiai/flovira-vue-designer/antdv'   // ← antd 适配器子入口
