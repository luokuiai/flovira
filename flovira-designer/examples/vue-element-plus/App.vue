        ...
        <div class="demo-hero-inner">
          <div class="demo-hero-text">
            <div class="demo-hero-brand">
              ...
              <h1>Flovira Designer<span class="ui-badge ui-badge--ep">Element Plus</span></h1>
            </div>
...
import { elementPlusAdapter } from '@luokuiai/flovira-vue-designer/element-plus'   // ← Element Plus 适配器子入口
...
// 右侧实时面板展示 useFlowJson 实时 JSON、事件日志（change/dirty/validate-error/node-click）、
...
async function saveDesign() {
  ...
  try {
    ...
    ElMessage.success('保存成功，流程ID：' + (response.data || ''))
  } catch (error) {
