...
export const subProcessIcon = `
<svg viewBox="0 0 100 80" xmlns="http://www.w3.org/2000/svg">
  <rect x="5" y="5" width="90" height="70" rx="8" fill="${rgba(COLOR.subProcess, 0.12)}" stroke="${stroke(COLOR.subProcess)}" stroke-width="1.8"/>
  <rect x="18" y="20" width="28" height="22" rx="4" fill="${ICON_BG}" stroke="${stroke(COLOR.subProcess)}" stroke-width="1.5"/>
  <rect x="54" y="38" width="28" height="22" rx="4" fill="${ICON_BG}" stroke="${stroke(COLOR.subProcess)}" stroke-width="1.5"/>
  <path d="M46 31h12v7" fill="none" stroke="${stroke(COLOR.subProcess)}" stroke-width="2"/>
</svg>`
