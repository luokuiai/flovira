...
const JSON_EXT_CODES = ['subprocessConfig', 'waitConfig', 'timeoutConfig']
...
/**
 * 将LogicFlow的数据转成flovira的json定义文件
 * @param {*} data(...definitionInfo,nodes,edges)
 * @returns
 */
export const logicFlowJsonToFlovira = (data) => {
  // 先构建成流程对象
...
export const setCommonStyle = (style, properties, nodeType, type = undefined) => {
