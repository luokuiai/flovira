...
async function main() {
  ...
  const mdPath = path.join(__dirname, 'flovira-npm-refactoring-plan.md');
  ...
  const doc = new Document({
    ...
    sections: [{
      ...
      headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: 'flovira-ui NPM \u6539\u9020\u5b9e\u65bd\u65b9\u6848', size: 18, color: '888888' })] })] }) },
  ...
  const outputPath = path.join(__dirname, 'Flovira-NPM改造完整实施方案.docx');
