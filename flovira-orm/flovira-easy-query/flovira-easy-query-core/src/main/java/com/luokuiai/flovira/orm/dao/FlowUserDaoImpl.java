...
import com.luokuiai.flovira.orm.entity.proxy.FlowUserProxy;
 ...
 * @author link2fun
 */
public class FlowUserDaoImpl extends FloviraDaoImpl<FlowUser, FlowUserProxy> implements FlowUserDao<FlowUser> {
