...
import com.luokuiai.flovira.orm.entity.proxy.FlowSkipProxy;
 ...
 * @author link2fun
 */
public class FlowSkipDaoImpl extends FloviraDaoImpl<FlowSkip, FlowSkipProxy> implements FlowSkipDao<FlowSkip> {
