...
import com.luokuiai.flovira.orm.utils.UISort;
 ...
 * @author link2fun
 */
public abstract class FloviraDaoImpl<T extends RootEntity & ProxyEntityAvailable<T, P>, P extends ProxyEntity<P, T>>
    implements FloviraDao<T> {
