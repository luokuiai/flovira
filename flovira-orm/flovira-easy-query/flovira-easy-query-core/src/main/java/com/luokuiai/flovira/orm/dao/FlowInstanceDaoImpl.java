...
import com.luokuiai.flovira.orm.entity.proxy.FlowInstanceProxy;
 ...
 * @author link2fun
 */
public class FlowInstanceDaoImpl extends FloviraDaoImpl<FlowInstance, FlowInstanceProxy> implements FlowInstanceDao<FlowInstance> {
    ...
    public SQLActionExpression1<FlowInstanceProxy> buildWhereCondition(FlowInstance entity) {
        return o -> {
            ...
            o.businessType().eq(StringUtils.isNotEmpty(entity.getBusinessType()), entity.getBusinessType());
