...
import com.luokuiai.flovira.orm.entity.proxy.FlowHisTaskProxy;
 ...
 * @author link2fun
 */
public class FlowHisTaskDaoImpl extends FloviraDaoImpl<FlowHisTask, FlowHisTaskProxy> implements FlowHisTaskDao<FlowHisTask> {
