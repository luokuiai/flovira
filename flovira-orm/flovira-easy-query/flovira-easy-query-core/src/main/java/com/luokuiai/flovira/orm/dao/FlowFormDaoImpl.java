...
import com.luokuiai.flovira.orm.entity.proxy.FlowFormProxy;
 ...
 */
public class FlowFormDaoImpl extends FloviraDaoImpl<FlowForm, FlowFormProxy> implements FlowFormDao<FlowForm> {
