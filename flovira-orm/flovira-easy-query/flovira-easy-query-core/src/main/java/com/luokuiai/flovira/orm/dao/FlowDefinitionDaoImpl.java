...
import com.luokuiai.flovira.orm.entity.proxy.FlowDefinitionProxy;
 ...
 * @author link2fun
 */
public class FlowDefinitionDaoImpl extends FloviraDaoImpl<FlowDefinition, FlowDefinitionProxy> implements FlowDefinitionDao<FlowDefinition> {
