...
import com.luokuiai.flovira.orm.entity.proxy.FlowNodeProxy;
 ...
 * @author link2fun
 */
public class FlowNodeDaoImpl extends FloviraDaoImpl<FlowNode, FlowNodeProxy> implements FlowNodeDao<FlowNode> {
