...
import com.luokuiai.flovira.orm.mapper.FlowInstanceMapper;
 ...
 * @since 2023-03-29
 */
public class FlowInstanceDaoImpl extends FloviraDaoImpl<FlowInstance> implements FlowInstanceDao<FlowInstance> {
    ...
    @Override
    public FlowInstance lockForUpdate(String tenantId, Long instanceId) {
        return getMapper().lockForUpdate(tenantId, instanceId);
    }
