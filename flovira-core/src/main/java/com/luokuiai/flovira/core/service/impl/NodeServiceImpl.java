 ...
 */
@Slf4j
public class NodeServiceImpl extends FloviraServiceImpl<FlowNodeDao<Node>, Node> implements NodeService {

    @Override
    public NodeService setDao(FlowNodeDao<Node> floviraDao) {
    ...
    public Map<String, String> getExt(Node node) {
        return ExtConfigUtil.read(node.getExt());
    }
