 ...
 */
package com.luokuiai.flovira.core.orm.service.impl;
...
import com.luokuiai.flovira.core.utils.SqlHelper;
 ...
 * @since 2023-03-17
 */
public abstract class FloviraServiceImpl<M extends FloviraDao<T>, T> implements IFloviraService<T> {

    protected M floviraDao;
    ...
    protected abstract IFloviraService<T> setDao(M floviraDao);
    ...
    @Override
    public List<T> list(T entity, FloviraQuery<T> query) {
    ...
    public FloviraQuery<T> orderById() {
        return new FloviraQuery<>(this).orderById();
    }
    ...
    public FloviraQuery<T> orderByAsc(String orderByField) {
        return new FloviraQuery<>(this).orderByAsc(orderByField);
    }

    @Override
    public FloviraQuery<T> orderByDesc(String orderByField) {
        return new FloviraQuery<>(this).orderByDesc(orderByField);
    }

    @Override
    public FloviraQuery<T> orderBy(String orderByField) {
        return new FloviraQuery<>(this).orderBy(orderByField);
    }
