...
public class FlowConfigCons {
     ...
     * 数据填充处理类路径
     */
    public static final String DATA_FILL_HANDLE_PATH = "flovira.data-fill-handler-path";

    /**
     * 租户处理类路径
     */
    public static final String TENANT_HANDLER_PATH = "flovira.tenant_handler_path";
    /**
     ...
     * 如果需要工作流共享业务系统权限
     */
    public static final String TOKEN_NAME = "flovira.token-name";
}
