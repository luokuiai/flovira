 ...
 */
package com.luokuiai.flovira.core.orm.service;
 ...
 * @since 2023-03-17
 */
public interface IFloviraService<T> {

    <M extends FloviraDao<T>> M getDao();
     ...
     * @return 集合
     */
    List<T> list(T entity, FloviraQuery<T> query);
     ...
     * @return 集合
     */
    FloviraQuery<T> orderByAsc(String orderByField);
     ...
     * @return 集合
     */
    FloviraQuery<T> orderByDesc(String orderByField);
     ...
     * @return 集合
     */
    FloviraQuery<T> orderBy(String orderByField);
}
