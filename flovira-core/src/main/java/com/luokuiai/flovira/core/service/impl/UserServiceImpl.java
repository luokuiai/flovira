...
import com.luokuiai.flovira.core.utils.ArrayUtil;
 ...
 */
public class UserServiceImpl extends FloviraServiceImpl<FlowUserDao<User>, User> implements UserService {

    @Override
    public UserService setDao(FlowUserDao<User> floviraDao) {
