# designer-integration-contract Specification

## Purpose
Define versioned, host-neutral capability, resource, relationship, and approver contracts shared by the engine and designers.
