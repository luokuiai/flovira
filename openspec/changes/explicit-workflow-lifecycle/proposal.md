...
- Provide stable listener codes, versioned subscriptions, and equivalent Vue / React configuration panels.
...
- `workflow-lifecycle`: Eight events, node execution identities, approval results, participant snapshots, delivery phases, subscriptions, and migration contracts.
...
- JSON / UI: Versioned configuration, capability discovery, import/export validation, and both designers.
